...
void time_init(const Color us, const int ply)
{
  ...
  if (use_time_management()) {
    int strength = log(max(1, (Time.optimumTime * Threads.numThreads  / 10))) * 60;
