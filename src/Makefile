...
help:
	@echo ""
	@echo "To compile Big Ballz, type: "
	@echo ""
...
profileclean:
	...
	@rm -f big_ballz.profdata *.profraw
...
clang-profile-use:
	$(XCRUN) llvm-profdata merge -output=big_ballz.profdata *.profraw
	$(MAKE) ARCH=$(ARCH) COMP=$(COMP) \
	EXTRACFLAGS='-fprofile-instr-use=big_ballz.profdata' \
